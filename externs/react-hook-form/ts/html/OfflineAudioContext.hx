...
**/
@:native("OfflineAudioContext") extern class OfflineAudioContext {
	@:overload(function(numberOfChannels:Float, length:Float, sampleRate:Float):OfflineAudioContext { })
	...
	**/
	...
	function createPeriodicWave(real:ts.AnyOf2<Array<Float>, ts.lib.Float32Array>, imag:ts.AnyOf2<Array<Float>, ts.lib.Float32Array>, ?constraints:PeriodicWaveConstraints):PeriodicWave;
	...
	**/
	...
	static var prototype : OfflineAudioContext;
}