...
typedef INavigator = {
	...
	function sendBeacon(url:String, ?data:ts.AnyOf14<String, Blob, ts.lib.ArrayBuffer, ts.lib.Float32Array, ts.lib.Float64Array, FormData, ts.lib.Uint8Array, ts.lib.Int8Array, ts.lib.Int16Array, ts.lib.Int32Array, ts.lib.Uint16Array, ts.lib.Uint32Array, ts.lib.Uint8ClampedArray, ts.lib.DataView>):Bool;
