...
@:native("Uint8ClampedArray") extern class Uint8ClampedArray {
	@:overload(function(arrayOrArrayBuffer:ts.AnyOf3<ArrayBuffer, SharedArrayBuffer, ArrayLike<Float>>):Uint8ClampedArray { })
	@:overload(function(buffer:ts.AnyOf2<ArrayBuffer, SharedArrayBuffer>, byteOffset:Float, ?length:Float):Uint8ClampedArray { })
	...
	**/
	static function of(items:haxe.extern.Rest<Float>):Uint8ClampedArray;
	/**
