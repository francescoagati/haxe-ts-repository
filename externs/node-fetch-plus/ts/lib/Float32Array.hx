...
@:native("Float32Array") extern class Float32Array {
	@:overload(function(arrayOrArrayBuffer:ts.AnyOf3<ArrayBuffer, SharedArrayBuffer, ArrayLike<Float>>):Float32Array { })
	@:overload(function(buffer:ts.AnyOf2<ArrayBuffer, SharedArrayBuffer>, byteOffset:Float, ?length:Float):Float32Array { })
