...
@:jsRequire("net", "Socket") extern class Socket extends node_fetch_plus.stream.Duplex {
	function new(?options:SocketConstructorOpts);
	@:overload(function(str:ts.AnyOf2<String, ts.lib.Uint8Array>, ?encoding:String, ?cb:ts.AnyOf2<() -> Void, (err:ts.lib.Error) -> Void>):Bool { })
	function write(buffer:ts.AnyOf2<String, ts.lib.Uint8Array>, ?cb:ts.AnyOf2<() -> Void, (err:ts.lib.Error) -> Void>):Bool;
	...
	@:overload(function(buffer:ts.AnyOf2<String, ts.lib.Uint8Array>, ?cb:() -> Void):Void { })
	@:overload(function(str:ts.AnyOf2<String, ts.lib.Uint8Array>, ?encoding:String, ?cb:() -> Void):Void { })
