package node_fetch_plus.http;
@:jsRequire("http", "IncomingMessage") extern class IncomingMessage extends node_fetch_plus.stream.Readable {
	function new(socket:node_fetch_plus.net.Socket);
	var aborted : Bool;
	var httpVersion : String;
	var httpVersionMajor : Float;
	var httpVersionMinor : Float;
	var complete : Bool;
	var connection : node_fetch_plus.net.Socket;
	var socket : node_fetch_plus.net.Socket;
	...
	**/
	...
	@:overload(function(event:String, listener:(err:ts.lib.Error) -> Void):IncomingMessage { })
	@:overload(function(event:String, listener:() -> Void):IncomingMessage { })
	@:overload(function(event:String, listener:() -> Void):IncomingMessage { })
	@:overload(function(event:String, listener:() -> Void):IncomingMessage { })
