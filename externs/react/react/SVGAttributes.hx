...
typedef SVGAttributes<T> = {
	...
	@:optional
	var accentHeight : ts.AnyOf2<String, Float>;
	@:optional
	...
	@:optional
	var alphabetic : ts.AnyOf2<String, Float>;
	@:optional
	var amplitude : ts.AnyOf2<String, Float>;
	@:optional
	var arabicForm : String;
	@:optional
	var ascent : ts.AnyOf2<String, Float>;
	@:optional
	var attributeName : String;
	@:optional
	var attributeType : String;
	@:optional
	var autoReverse : ts.AnyOf2<Bool, String>;
	@:optional
	var azimuth : ts.AnyOf2<String, Float>;
	@:optional
	var baseFrequency : ts.AnyOf2<String, Float>;
	@:optional
	var baselineShift : ts.AnyOf2<String, Float>;
	@:optional
	var baseProfile : ts.AnyOf2<String, Float>;
	@:optional
	var bbox : ts.AnyOf2<String, Float>;
	@:optional
	var begin : ts.AnyOf2<String, Float>;
	@:optional
	var bias : ts.AnyOf2<String, Float>;
	@:optional
	var by : ts.AnyOf2<String, Float>;
	@:optional
	var calcMode : ts.AnyOf2<String, Float>;
	@:optional
	var capHeight : ts.AnyOf2<String, Float>;
	@:optional
	var clip : ts.AnyOf2<String, Float>;
	@:optional
	var clipPath : String;
	@:optional
	var clipPathUnits : ts.AnyOf2<String, Float>;
	@:optional
	var clipRule : ts.AnyOf2<String, Float>;
	@:optional
	var colorInterpolation : ts.AnyOf2<String, Float>;
	@:optional
	var colorInterpolationFilters : String;
	@:optional
	var colorProfile : ts.AnyOf2<String, Float>;
	@:optional
	var colorRendering : ts.AnyOf2<String, Float>;
	@:optional
	var contentScriptType : ts.AnyOf2<String, Float>;
	@:optional
	var contentStyleType : ts.AnyOf2<String, Float>;
	@:optional
	var cursor : ts.AnyOf2<String, Float>;
	@:optional
	var cx : ts.AnyOf2<String, Float>;
	@:optional
	var cy : ts.AnyOf2<String, Float>;
	@:optional
	var d : String;
	@:optional
	var decelerate : ts.AnyOf2<String, Float>;
	@:optional
	var descent : ts.AnyOf2<String, Float>;
	@:optional
	var diffuseConstant : ts.AnyOf2<String, Float>;
	@:optional
	var direction : ts.AnyOf2<String, Float>;
	@:optional
	var display : ts.AnyOf2<String, Float>;
	@:optional
	var divisor : ts.AnyOf2<String, Float>;
	@:optional
	var dominantBaseline : ts.AnyOf2<String, Float>;
	@:optional
	var dur : ts.AnyOf2<String, Float>;
	@:optional
	var dx : ts.AnyOf2<String, Float>;
	@:optional
	var dy : ts.AnyOf2<String, Float>;
	@:optional
	var edgeMode : ts.AnyOf2<String, Float>;
	@:optional
	var elevation : ts.AnyOf2<String, Float>;
	@:optional
	var enableBackground : ts.AnyOf2<String, Float>;
	@:optional
	var end : ts.AnyOf2<String, Float>;
	@:optional
	var exponent : ts.AnyOf2<String, Float>;
	@:optional
	var externalResourcesRequired : ts.AnyOf2<Bool, String>;
	@:optional
	var fill : String;
	@:optional
	var fillOpacity : ts.AnyOf2<String, Float>;
	@:optional
	var fillRule : String;
	@:optional
	var filter : String;
	@:optional
	var filterRes : ts.AnyOf2<String, Float>;
	@:optional
	var filterUnits : ts.AnyOf2<String, Float>;
	@:optional
	var floodColor : ts.AnyOf2<String, Float>;
	@:optional
	var floodOpacity : ts.AnyOf2<String, Float>;
	@:optional
	var focusable : ts.AnyOf2<Bool, String>;
	@:optional
	var fontFamily : String;
	@:optional
	var fontSize : ts.AnyOf2<String, Float>;
	@:optional
	var fontSizeAdjust : ts.AnyOf2<String, Float>;
	@:optional
	var fontStretch : ts.AnyOf2<String, Float>;
	@:optional
	var fontStyle : ts.AnyOf2<String, Float>;
	@:optional
	var fontVariant : ts.AnyOf2<String, Float>;
	@:optional
	var fontWeight : ts.AnyOf2<String, Float>;
	@:optional
	var format : ts.AnyOf2<String, Float>;
	@:optional
	var from : ts.AnyOf2<String, Float>;
	@:optional
	var fx : ts.AnyOf2<String, Float>;
	@:optional
	var fy : ts.AnyOf2<String, Float>;
	@:optional
	var g1 : ts.AnyOf2<String, Float>;
	@:optional
	var g2 : ts.AnyOf2<String, Float>;
	@:optional
	var glyphName : ts.AnyOf2<String, Float>;
	@:optional
	var glyphOrientationHorizontal : ts.AnyOf2<String, Float>;
	@:optional
	var glyphOrientationVertical : ts.AnyOf2<String, Float>;
	@:optional
	var glyphRef : ts.AnyOf2<String, Float>;
	@:optional
	var gradientTransform : String;
	@:optional
	var gradientUnits : String;
	@:optional
	var hanging : ts.AnyOf2<String, Float>;
	@:optional
	var horizAdvX : ts.AnyOf2<String, Float>;
	@:optional
	var horizOriginX : ts.AnyOf2<String, Float>;
	@:optional
	var href : String;
	@:optional
	var ideographic : ts.AnyOf2<String, Float>;
	@:optional
	var imageRendering : ts.AnyOf2<String, Float>;
	@:optional
	var in2 : ts.AnyOf2<String, Float>;
	@:native("in")
	@:optional
	var in_ : String;
	@:optional
	var intercept : ts.AnyOf2<String, Float>;
	@:optional
	var k1 : ts.AnyOf2<String, Float>;
	@:optional
	var k2 : ts.AnyOf2<String, Float>;
	@:optional
	var k3 : ts.AnyOf2<String, Float>;
	@:optional
	var k4 : ts.AnyOf2<String, Float>;
	@:optional
	var k : ts.AnyOf2<String, Float>;
	@:optional
	var kernelMatrix : ts.AnyOf2<String, Float>;
	@:optional
	var kernelUnitLength : ts.AnyOf2<String, Float>;
	@:optional
	var kerning : ts.AnyOf2<String, Float>;
	@:optional
	var keyPoints : ts.AnyOf2<String, Float>;
	@:optional
	var keySplines : ts.AnyOf2<String, Float>;
	@:optional
	var keyTimes : ts.AnyOf2<String, Float>;
	@:optional
	var lengthAdjust : ts.AnyOf2<String, Float>;
	@:optional
	var letterSpacing : ts.AnyOf2<String, Float>;
	@:optional
	var lightingColor : ts.AnyOf2<String, Float>;
	@:optional
	var limitingConeAngle : ts.AnyOf2<String, Float>;
	@:optional
	var local : ts.AnyOf2<String, Float>;
	@:optional
	var markerEnd : String;
	@:optional
	var markerHeight : ts.AnyOf2<String, Float>;
	@:optional
	var markerMid : String;
	@:optional
	var markerStart : String;
	@:optional
	var markerUnits : ts.AnyOf2<String, Float>;
	@:optional
	var markerWidth : ts.AnyOf2<String, Float>;
	@:optional
	var mask : String;
	@:optional
	var maskContentUnits : ts.AnyOf2<String, Float>;
	@:optional
	var maskUnits : ts.AnyOf2<String, Float>;
	@:optional
	var mathematical : ts.AnyOf2<String, Float>;
	@:optional
	var mode : ts.AnyOf2<String, Float>;
	@:optional
	var numOctaves : ts.AnyOf2<String, Float>;
	@:optional
	...
	@:native("operator")
	@:optional
	var operator_ : ts.AnyOf2<String, Float>;
	@:optional
	var order : ts.AnyOf2<String, Float>;
	@:optional
	var orient : ts.AnyOf2<String, Float>;
	@:optional
	var orientation : ts.AnyOf2<String, Float>;
	@:optional
	var origin : ts.AnyOf2<String, Float>;
	@:optional
	var overflow : ts.AnyOf2<String, Float>;
	@:optional
	var overlinePosition : ts.AnyOf2<String, Float>;
	@:optional
	var overlineThickness : ts.AnyOf2<String, Float>;
	@:optional
	var paintOrder : ts.AnyOf2<String, Float>;
	@:optional
	var panose1 : ts.AnyOf2<String, Float>;
	@:optional
	var path : String;
	@:optional
	var pathLength : ts.AnyOf2<String, Float>;
	@:optional
	var patternContentUnits : String;
	@:optional
	var patternTransform : ts.AnyOf2<String, Float>;
	@:optional
	var patternUnits : String;
	@:optional
	var pointerEvents : ts.AnyOf2<String, Float>;
	@:optional
	var points : String;
	@:optional
	var pointsAtX : ts.AnyOf2<String, Float>;
	@:optional
	var pointsAtY : ts.AnyOf2<String, Float>;
	@:optional
	var pointsAtZ : ts.AnyOf2<String, Float>;
	@:optional
	var preserveAlpha : ts.AnyOf2<Bool, String>;
	@:optional
	var preserveAspectRatio : String;
	@:optional
	var primitiveUnits : ts.AnyOf2<String, Float>;
	@:optional
	var r : ts.AnyOf2<String, Float>;
	@:optional
	var radius : ts.AnyOf2<String, Float>;
	@:optional
	var refX : ts.AnyOf2<String, Float>;
	@:optional
	var refY : ts.AnyOf2<String, Float>;
	@:optional
	var renderingIntent : ts.AnyOf2<String, Float>;
	@:optional
	var repeatCount : ts.AnyOf2<String, Float>;
	@:optional
	var repeatDur : ts.AnyOf2<String, Float>;
	@:optional
	var requiredExtensions : ts.AnyOf2<String, Float>;
	@:optional
	var requiredFeatures : ts.AnyOf2<String, Float>;
	@:optional
	var restart : ts.AnyOf2<String, Float>;
	@:optional
	var result : String;
	@:optional
	var rotate : ts.AnyOf2<String, Float>;
	@:optional
	var rx : ts.AnyOf2<String, Float>;
	@:optional
	var ry : ts.AnyOf2<String, Float>;
	@:optional
	var scale : ts.AnyOf2<String, Float>;
	@:optional
	var seed : ts.AnyOf2<String, Float>;
	@:optional
	var shapeRendering : ts.AnyOf2<String, Float>;
	@:optional
	var slope : ts.AnyOf2<String, Float>;
	@:optional
	var spacing : ts.AnyOf2<String, Float>;
	@:optional
	var specularConstant : ts.AnyOf2<String, Float>;
	@:optional
	var specularExponent : ts.AnyOf2<String, Float>;
	@:optional
	var speed : ts.AnyOf2<String, Float>;
	@:optional
	var spreadMethod : String;
	@:optional
	var startOffset : ts.AnyOf2<String, Float>;
	@:optional
	var stdDeviation : ts.AnyOf2<String, Float>;
	@:optional
	var stemh : ts.AnyOf2<String, Float>;
	@:optional
	var stemv : ts.AnyOf2<String, Float>;
	@:optional
	var stitchTiles : ts.AnyOf2<String, Float>;
	@:optional
	var stopColor : String;
	@:optional
	var stopOpacity : ts.AnyOf2<String, Float>;
	@:optional
	var strikethroughPosition : ts.AnyOf2<String, Float>;
	@:optional
	var strikethroughThickness : ts.AnyOf2<String, Float>;
	@:optional
	var string : ts.AnyOf2<String, Float>;
	@:optional
	var stroke : String;
	@:optional
	...
	@:optional
	var strokeMiterlimit : ts.AnyOf2<String, Float>;
	@:optional
	var strokeOpacity : ts.AnyOf2<String, Float>;
	@:optional
	var strokeWidth : ts.AnyOf2<String, Float>;
	@:optional
	var surfaceScale : ts.AnyOf2<String, Float>;
	@:optional
	var systemLanguage : ts.AnyOf2<String, Float>;
	@:optional
	var tableValues : ts.AnyOf2<String, Float>;
	@:optional
	var targetX : ts.AnyOf2<String, Float>;
	@:optional
	var targetY : ts.AnyOf2<String, Float>;
	@:optional
	var textAnchor : String;
	@:optional
	var textDecoration : ts.AnyOf2<String, Float>;
	@:optional
	var textLength : ts.AnyOf2<String, Float>;
	@:optional
	var textRendering : ts.AnyOf2<String, Float>;
	@:optional
	var to : ts.AnyOf2<String, Float>;
	@:optional
	var transform : String;
	@:optional
	var u1 : ts.AnyOf2<String, Float>;
	@:optional
	var u2 : ts.AnyOf2<String, Float>;
	@:optional
	var underlinePosition : ts.AnyOf2<String, Float>;
	@:optional
	var underlineThickness : ts.AnyOf2<String, Float>;
	@:optional
	var unicode : ts.AnyOf2<String, Float>;
	@:optional
	var unicodeBidi : ts.AnyOf2<String, Float>;
	@:optional
	var unicodeRange : ts.AnyOf2<String, Float>;
	@:optional
	var unitsPerEm : ts.AnyOf2<String, Float>;
	@:optional
	var vAlphabetic : ts.AnyOf2<String, Float>;
	@:optional
	var values : String;
	@:optional
	var vectorEffect : ts.AnyOf2<String, Float>;
	@:optional
	var version : String;
	@:optional
	var vertAdvY : ts.AnyOf2<String, Float>;
	@:optional
	var vertOriginX : ts.AnyOf2<String, Float>;
	@:optional
	var vertOriginY : ts.AnyOf2<String, Float>;
	@:optional
	var vHanging : ts.AnyOf2<String, Float>;
	@:optional
	var vIdeographic : ts.AnyOf2<String, Float>;
	@:optional
	var viewBox : String;
	@:optional
	var viewTarget : ts.AnyOf2<String, Float>;
	@:optional
	var visibility : ts.AnyOf2<String, Float>;
	@:optional
	var vMathematical : ts.AnyOf2<String, Float>;
	@:optional
	var widths : ts.AnyOf2<String, Float>;
	@:optional
	var wordSpacing : ts.AnyOf2<String, Float>;
	@:optional
	var writingMode : ts.AnyOf2<String, Float>;
	@:optional
	var x1 : ts.AnyOf2<String, Float>;
	@:optional
	var x2 : ts.AnyOf2<String, Float>;
	@:optional
	var x : ts.AnyOf2<String, Float>;
	@:optional
	var xChannelSelector : String;
	@:optional
	var xHeight : ts.AnyOf2<String, Float>;
	@:optional
	...
	var xmlSpace : String;
	@:optional
	var y1 : ts.AnyOf2<String, Float>;
	@:optional
	var y2 : ts.AnyOf2<String, Float>;
	@:optional
