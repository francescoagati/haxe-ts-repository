package react;
@:jsRequire("react", "Component") extern class Component<P, S, SS> {
	@:overload(function<P, S, SS>(props:P, ?context:Dynamic):Component<P, S, SS> { })
	...
	**/
	@:optional
	static var contextType : Context<Dynamic>;
}