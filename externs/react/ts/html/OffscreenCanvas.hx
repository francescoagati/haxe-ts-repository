...
@:native("OffscreenCanvas") extern class OffscreenCanvas {
	...
	**/
	...
	@:overload(function(contextId:OffscreenRenderingContextId, ?options:Dynamic):Null<ts.AnyOf4<ImageBitmapRenderingContext, WebGLRenderingContext, WebGL2RenderingContext, OffscreenCanvasRenderingContext2D>> { })
