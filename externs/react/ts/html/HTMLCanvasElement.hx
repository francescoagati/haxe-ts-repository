...
**/
@:native("HTMLCanvasElement") extern class HTMLCanvasElement {
	function new();
	/**
	...
	**/
	...
	@:overload(function(contextId:String, ?options:Dynamic):Null<ts.AnyOf4<ImageBitmapRenderingContext, WebGLRenderingContext, WebGL2RenderingContext, CanvasRenderingContext2D>> { })
	function getContext(contextId:String, ?options:CanvasRenderingContext2DSettings):Null<CanvasRenderingContext2D>;
	...
	**/
	...
	static var prototype : HTMLCanvasElement;
}