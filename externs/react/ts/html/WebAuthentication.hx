...
@:native("WebAuthentication") extern class WebAuthentication {
	function new();
	function getAssertion(assertionChallenge:Null<ts.AnyOf11<ts.lib.Float32Array, ts.lib.ArrayBuffer, ts.lib.Int32Array, ts.lib.Uint32Array, ts.lib.Float64Array, ts.lib.Uint8Array, ts.lib.Int8Array, ts.lib.Int16Array, ts.lib.Uint16Array, ts.lib.Uint8ClampedArray, ts.lib.DataView>>, ?options:AssertionOptions):ts.lib.Promise<WebAuthnAssertion>;
