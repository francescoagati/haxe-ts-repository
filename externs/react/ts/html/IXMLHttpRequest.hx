...
typedef IXMLHttpRequest = {
	...
	**/
	function send(?body:ts.AnyOf8<String, Document, Blob, ts.lib.ArrayBufferView, ts.lib.ArrayBuffer, FormData, URLSearchParams, ReadableStream<ts.lib.Uint8Array>>):Void;
	/**
