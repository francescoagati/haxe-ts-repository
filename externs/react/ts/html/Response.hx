...
@:native("Response") extern class Response {
	function new(?body:ts.AnyOf7<String, Blob, ts.lib.ArrayBufferView, ts.lib.ArrayBuffer, FormData, URLSearchParams, ReadableStream<ts.lib.Uint8Array>>, ?init:ResponseInit);
