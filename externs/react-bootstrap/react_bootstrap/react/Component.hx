...
@jsInaccessible extern class Component<P, S, SS> {
	@:overload(function<P, S, SS>(props:P, ?context:Dynamic):react_bootstrap.react.Component<P, S, SS> { })
	function new<P, S, SS>(props:{ });
	/**
	...
	**/
	var context : Dynamic;
	function setState<K>(state:Null<ts.AnyOf3<S, (prevState:{ }, props:{ }) -> Null<ts.AnyOf2<S, { }>>, { }>>, ?callback:() -> Void):Void;
	function forceUpdate(?callback:() -> Void):Void;
	function render():react_bootstrap.react.ReactNode;
	final props : Dynamic;
	var state : { };
	var refs : { };
	/**
	...
	**/
	@:optional
	function componentDidCatch(error:ts.lib.Error, errorInfo:react_bootstrap.react.ErrorInfo):Void;
	/**
	...
	**/
	@:optional
	static var contextType : react_bootstrap.react.Context<Dynamic>;
}