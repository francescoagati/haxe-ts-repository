...
typedef ISVGSVGElement = {
	...
	function getEnclosureList(rect:DOMRect, referenceElement:SVGElement):NodeListOf<ts.AnyOf10<SVGCircleElement, SVGEllipseElement, SVGImageElement, SVGLineElement, SVGPathElement, SVGPolygonElement, SVGPolylineElement, SVGRectElement, SVGTextElement, SVGUseElement>>;
	function getIntersectionList(rect:DOMRect, referenceElement:SVGElement):NodeListOf<ts.AnyOf10<SVGCircleElement, SVGEllipseElement, SVGImageElement, SVGLineElement, SVGPathElement, SVGPolygonElement, SVGPolylineElement, SVGRectElement, SVGTextElement, SVGUseElement>>;
