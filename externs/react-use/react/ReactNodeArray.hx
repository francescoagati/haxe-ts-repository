...
typedef ReactNodeArray = {
	...
	**/
	...
	/**
		...
		Combines two or more arrays.
	**/
	@:overload(function(items:haxe.extern.Rest<Null<ts.AnyOf8<String, Float, Bool, { }, ReactElement<Dynamic, ts.AnyOf3<String, (props:Dynamic) -> Null<ReactElement<Dynamic, Dynamic>>, { }>>, ReactNodeArray, ReactPortal, ts.lib.ConcatArray<ReactNode>>>>):Array<ReactNode> { })
	...
	**/
	...
	/**
		Sorts an array.
	**/
	function sort(?compareFn:(a:ReactNode, b:ReactNode) -> Float):ReactNodeArray;
	/**
	...
	**/
	function fill(value:ReactNode, ?start:Float, ?end:Float):ReactNodeArray;
	/**
		Returns the this object after copying a section of the array identified by start and end
		to the same array starting at position target
	**/
	function copyWithin(target:Float, start:Float, ?end:Float):ReactNodeArray;
	/**
