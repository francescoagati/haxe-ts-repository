...
@:native("XMLHttpRequest") extern class XMLHttpRequest {
	...
	**/
	function send(?body:ts.AnyOf8<String, Document, Blob, ts.lib.ArrayBuffer, FormData, URLSearchParams, ts.lib.ArrayBufferView, ReadableStream<ts.lib.Uint8Array>>):Void;
	/**
