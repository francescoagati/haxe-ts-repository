...
@:native("Response") extern class Response {
	function new(?body:ts.AnyOf7<String, Blob, ts.lib.ArrayBuffer, FormData, URLSearchParams, ts.lib.ArrayBufferView, ReadableStream<ts.lib.Uint8Array>>, ?init:ResponseInit);
