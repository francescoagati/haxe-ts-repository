...
typedef ISVGSVGElement = {
	...
	var onzoom : Null<(ev:SVGZoomEvent) -> Dynamic>;
	...
	function getEnclosureList(rect:DOMRect, referenceElement:SVGElement):NodeListOf<ts.AnyOf10<SVGImageElement, SVGCircleElement, SVGEllipseElement, SVGLineElement, SVGPathElement, SVGPolygonElement, SVGPolylineElement, SVGRectElement, SVGTextElement, SVGUseElement>>;
	function getIntersectionList(rect:DOMRect, referenceElement:SVGElement):NodeListOf<ts.AnyOf10<SVGImageElement, SVGCircleElement, SVGEllipseElement, SVGLineElement, SVGPathElement, SVGPolygonElement, SVGPolylineElement, SVGRectElement, SVGTextElement, SVGUseElement>>;
