...
@:native("Uint8Array") extern class Uint8Array {
	@:overload(function(arrayOrArrayBuffer:ts.AnyOf3<ArrayLike<Float>, ArrayBuffer, SharedArrayBuffer>):Uint8Array { })
	@:overload(function(buffer:ts.AnyOf2<ArrayBuffer, SharedArrayBuffer>, byteOffset:Float, ?length:Float):Uint8Array { })
	@:overload(function(elements:Iterable<Float>):Uint8Array { })
	@:overload(function():Uint8Array { })
