...
@:native("Object") extern class Object {
	...
	**/
	...
	static function values<T>(o:ts.AnyOf2<{ }, ArrayLike<T>>):Array<T>;
	/**
	...
	**/
	...
	static function entries<T>(o:ts.AnyOf2<{ }, ArrayLike<T>>):Array<ts.Tuple2<String, T>>;
	/**
		Returns an object containing all own property descriptors of an object
	**/
	static function getOwnPropertyDescriptors<T>(o:T):Dynamic;
}