...
@:jsRequire("cluster", "Worker") extern class Worker extends node.events.EventEmitter {
	...
	function send(message:node.child_process.Serializable, ?sendHandle:ts.AnyOf2<node.net.Socket, node.net.Server>, ?callback:(error:Null<ts.lib.Error>) -> Void):Bool;
	...
	**/
	...
	@:overload(function(event:String, listener:(error:ts.lib.Error) -> Void):Worker { })
