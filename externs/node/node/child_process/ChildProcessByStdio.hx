...
typedef ChildProcessByStdio<I, O, E> = {
	...
	**/
	...
	@:overload(function(event:String, listener:(err:ts.lib.Error) -> Void):ChildProcessByStdio<I, O, E> { })
	@:overload(function(event:String, listener:(code:Null<Float>, signal:Null<String>) -> Void):ChildProcessByStdio<I, O, E> { })
