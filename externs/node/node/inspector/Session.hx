...
@:jsRequire("inspector", "Session") extern class Session extends node.events.EventEmitter {
	...
	**/
	...
	@:overload(function(method:String, ?callback:(err:Null<ts.lib.Error>) -> Void):Void { })
	@:overload(function(method:String, ?callback:(err:Null<ts.lib.Error>) -> Void):Void { })
	@:overload(function(method:String, ?params:node.inspector.nodeworker.DetachParameterType, ?callback:(err:Null<ts.lib.Error>) -> Void):Void { })
	@:overload(function(method:String, ?callback:(err:Null<ts.lib.Error>) -> Void):Void { })
	@:overload(function(method:String, ?params:node.inspector.noderuntime.NotifyWhenWaitingForDisconnectParameterType, ?callback:(err:Null<ts.lib.Error>) -> Void):Void { })
	@:overload(function(method:String, ?callback:(err:Null<ts.lib.Error>) -> Void):Void { })
