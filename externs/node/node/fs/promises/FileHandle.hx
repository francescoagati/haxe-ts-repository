...
typedef FileHandle = {
	...
	**/
	function appendFile(data:ts.AnyOf2<String, ts.lib.Uint8Array>, ?options:ts.AnyOf2<String, node.fs.BaseEncodingOptions & { @:optional var mode : ts.AnyOf2<String, Float>; @:optional var flag : ts.AnyOf2<String, Float>; }>):ts.lib.Promise<Void>;
	/**
	...
	**/
	...
	@:overload(function(?options:ts.AnyOf2<String, node.fs.BaseEncodingOptions & { @:optional var flag : ts.AnyOf2<String, Float>; }>):ts.lib.Promise<ts.AnyOf2<String, global.Buffer>> { })
	...
	**/
	@:overload(function(data:ts.AnyOf2<String, ts.lib.Uint8Array>, ?position:Float, ?encoding:String):ts.lib.Promise<{
	...
	**/
	function writeFile(data:ts.AnyOf2<String, ts.lib.Uint8Array>, ?options:ts.AnyOf2<String, node.fs.BaseEncodingOptions & { @:optional var mode : ts.AnyOf2<String, Float>; @:optional var flag : ts.AnyOf2<String, Float>; }>):ts.lib.Promise<Void>;
	/**
		See `fs.writev` promisified version.
	**/
	function writev(buffers:Array<global.nodejs.ArrayBufferView>, ?position:Float):ts.lib.Promise<node.fs.WriteVResult>;
	/**
		See `fs.readv` promisified version.
	**/
	function readv(buffers:Array<global.nodejs.ArrayBufferView>, ?position:Float):ts.lib.Promise<node.fs.ReadVResult>;
	/**
