...
typedef TlsOptions = {
	...
	**/
	...
	@:optional
	function pskCallback(socket:TLSSocket, identity:String):Null<ts.AnyOf10<ts.lib.Uint8Array, ts.lib.Uint8ClampedArray, ts.lib.Uint16Array, ts.lib.Uint32Array, ts.lib.Int8Array, ts.lib.Int16Array, ts.lib.Int32Array, ts.lib.Float32Array, ts.lib.Float64Array, ts.lib.DataView>>;
	/**
	...
	**/
	@:optional
	var SNICallback : (servername:String, cb:(err:Null<ts.lib.Error>, ctx:SecureContext) -> Void) -> Void;
	/**
