...
@:jsRequire("dns", "Resolver") extern class Resolver {
	...
	var resolve : {
		...
		@:selfCall
		function call(hostname:String, callback:(err:Null<global.nodejs.ErrnoException>, addresses:Array<String>) -> Void):Void;
	};
	var resolve4 : {
	...
	var resolveAny : (hostname:String, callback:(err:Null<global.nodejs.ErrnoException>, addresses:Array<AnyRecord>) -> Void) -> Void;
	var resolveCname : (hostname:String, callback:(err:Null<global.nodejs.ErrnoException>, addresses:Array<String>) -> Void) -> Void;
	var resolveMx : (hostname:String, callback:(err:Null<global.nodejs.ErrnoException>, addresses:Array<MxRecord>) -> Void) -> Void;
	var resolveNaptr : (hostname:String, callback:(err:Null<global.nodejs.ErrnoException>, addresses:Array<NaptrRecord>) -> Void) -> Void;
	var resolveNs : (hostname:String, callback:(err:Null<global.nodejs.ErrnoException>, addresses:Array<String>) -> Void) -> Void;
	var resolvePtr : (hostname:String, callback:(err:Null<global.nodejs.ErrnoException>, addresses:Array<String>) -> Void) -> Void;
	var resolveSoa : (hostname:String, callback:(err:Null<global.nodejs.ErrnoException>, address:SoaRecord) -> Void) -> Void;
	var resolveSrv : (hostname:String, callback:(err:Null<global.nodejs.ErrnoException>, addresses:Array<SrvRecord>) -> Void) -> Void;
	var resolveTxt : (hostname:String, callback:(err:Null<global.nodejs.ErrnoException>, addresses:Array<Array<String>>) -> Void) -> Void;
	var reverse : (ip:String, callback:(err:Null<global.nodejs.ErrnoException>, hostnames:Array<String>) -> Void) -> Void;
