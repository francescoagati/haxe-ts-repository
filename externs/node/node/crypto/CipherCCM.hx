...
typedef CipherCCM = {
	...
	function update(data:ts.AnyOf11<String, ts.lib.Uint8Array, ts.lib.Uint8ClampedArray, ts.lib.Uint16Array, ts.lib.Uint32Array, ts.lib.Int8Array, ts.lib.Int16Array, ts.lib.Int32Array, ts.lib.Float32Array, ts.lib.Float64Array, ts.lib.DataView>):global.Buffer;
	@:native("final")
	...
	**/
	...
	@:overload(function(event:String, listener:(err:ts.lib.Error) -> Void):CipherCCM { })
	@:overload(function(event:String, listener:() -> Void):CipherCCM { })
	@:overload(function(event:String, listener:() -> Void):CipherCCM { })
	@:overload(function(event:String, listener:() -> Void):CipherCCM { })
