...
@:jsRequire("crypto", "Verify") extern class Verify extends node.stream.Writable {
	...
	function update(data:ts.AnyOf11<String, ts.lib.Uint8Array, ts.lib.Uint8ClampedArray, ts.lib.Uint16Array, ts.lib.Uint32Array, ts.lib.Int8Array, ts.lib.Int16Array, ts.lib.Int32Array, ts.lib.Float32Array, ts.lib.Float64Array, ts.lib.DataView>):Verify;
	@:overload(function(object:Dynamic, signature:String, ?signature_format:String):Bool { })
	function verify(object:Dynamic, signature:global.nodejs.ArrayBufferView):Bool;
	...
	**/
	...
	@:overload(function(event:String, listener:(err:ts.lib.Error) -> Void):Verify { })
	@:overload(function(event:String, listener:() -> Void):Verify { })
