...
@:jsRequire("v8", "Serializer") extern class Serializer {
	...
	**/
	function releaseBuffer():global.Buffer;
	/**
		Marks an ArrayBuffer as having its contents transferred out of band.\
		Pass the corresponding ArrayBuffer in the deserializing context to deserializer.transferArrayBuffer().
	**/
	function transferArrayBuffer(id:Float, arrayBuffer:ts.lib.ArrayBuffer):Void;
	/**
	...
	**/
	function writeRawBytes(buffer:global.nodejs.TypedArray):Void;
}