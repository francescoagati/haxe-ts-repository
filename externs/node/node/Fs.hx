...
@:jsRequire("fs") @valueModuleOnly extern class Fs {
	...
	**/
	...
	static function symlink(target:node.fs.PathLike, path:node.fs.PathLike, type:Null<String>, callback:node.fs.NoParamCallback):Void;
	/**
	...
	**/
	...
	static function readdir(path:node.fs.PathLike, options:Null<ts.AnyOf2<String, { var encoding : Null<String>; @:optional var withFileTypes : Bool; }>>, callback:(err:Null<global.nodejs.ErrnoException>, files:Array<String>) -> Void):Void;
	/**
	...
	**/
	static function utimes(path:node.fs.PathLike, atime:ts.AnyOf3<String, Float, ts.lib.Date_>, mtime:ts.AnyOf3<String, Float, ts.lib.Date_>, callback:node.fs.NoParamCallback):Void;
	/**
		Synchronously change file timestamps of the file referenced by the supplied path.
	**/
	static function utimesSync(path:node.fs.PathLike, atime:ts.AnyOf3<String, Float, ts.lib.Date_>, mtime:ts.AnyOf3<String, Float, ts.lib.Date_>):Void;
	/**
		Asynchronously change file timestamps of the file referenced by the supplied file descriptor.
	**/
	static function futimes(fd:Float, atime:ts.AnyOf3<String, Float, ts.lib.Date_>, mtime:ts.AnyOf3<String, Float, ts.lib.Date_>, callback:node.fs.NoParamCallback):Void;
	/**
		Synchronously change file timestamps of the file referenced by the supplied file descriptor.
	**/
	static function futimesSync(fd:Float, atime:ts.AnyOf3<String, Float, ts.lib.Date_>, mtime:ts.AnyOf3<String, Float, ts.lib.Date_>):Void;
	/**
	...
	**/
	...
	@:overload(function(fd:Float, string:String, position:Null<Float>, encoding:Null<String>, callback:(err:Null<global.nodejs.ErrnoException>, written:Float, str:String) -> Void):Void { })
	...
	**/
	@:overload(function(fd:Float, string:String, ?position:Float, ?encoding:String):Float { })
	...
	**/
	...
	static function readFile(path:ts.AnyOf4<String, Float, global.Buffer, node.url.URL>, options:Null<{ @:optional var encoding : Dynamic; @:optional var flag : String; }>, callback:(err:Null<global.nodejs.ErrnoException>, data:global.Buffer) -> Void):Void;
	/**
	...
	**/
	...
	/**
		...
		Asynchronously append data to a file, creating the file if it does not exist.
	**/
	@:overload(function(file:ts.AnyOf4<String, Float, global.Buffer, node.url.URL>, data:ts.AnyOf2<String, ts.lib.Uint8Array>, callback:node.fs.NoParamCallback):Void { })
	static function appendFile(file:ts.AnyOf4<String, Float, global.Buffer, node.url.URL>, data:ts.AnyOf2<String, ts.lib.Uint8Array>, options:node.fs.WriteFileOptions, callback:node.fs.NoParamCallback):Void;
	/**
		Synchronously append data to a file, creating the file if it does not exist.
	**/
	static function appendFileSync(file:ts.AnyOf4<String, Float, global.Buffer, node.url.URL>, data:ts.AnyOf2<String, ts.lib.Uint8Array>, ?options:ts.AnyOf2<String, node.fs.BaseEncodingOptions & { @:optional var mode : ts.AnyOf2<String, Float>; @:optional var flag : String; }>):Void;
	/**
	...
	**/
	static function createReadStream(path:node.fs.PathLike, ?options:ts.AnyOf2<String, { @:optional var flags : String; @:optional var encoding : String; @:optional var fd : Float; @:optional var mode : Float; @:optional var autoClose : Bool; @:optional var emitClose : Bool; @:optional var start : Float; @:optional var end : Float; @:optional var highWaterMark : Float; }>):node.fs.ReadStream;
	/**
		Returns a new `WriteStream` object.
	**/
	static function createWriteStream(path:node.fs.PathLike, ?options:ts.AnyOf2<String, { @:optional var flags : String; @:optional var encoding : String; @:optional var fd : Float; @:optional var mode : Float; @:optional var autoClose : Bool; @:optional var emitClose : Bool; @:optional var start : Float; @:optional var highWaterMark : Float; }>):node.fs.WriteStream;
	/**
