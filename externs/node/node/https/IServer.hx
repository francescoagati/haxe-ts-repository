...
typedef IServer = {
	...
	**/
	...
	/**
		...
		6. keylog
	**/
	@:overload(function(event:String, listener:(err:ts.lib.Error, tlsSocket:node.tls.TLSSocket) -> Void):Server { })
	...
	@:overload(function(event:String, err:ts.lib.Error, tlsSocket:node.tls.TLSSocket):Bool { })
