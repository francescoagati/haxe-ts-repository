...
@:jsRequire("http2", "Http2ServerResponse") extern class Http2ServerResponse extends node.stream.Stream {
	...
	@:overload(function(data:ts.AnyOf2<String, ts.lib.Uint8Array>, ?callback:() -> Void):Void { })
	@:overload(function(data:ts.AnyOf2<String, ts.lib.Uint8Array>, encoding:global.BufferEncoding, ?callback:() -> Void):Void { })
	...
	@:overload(function(chunk:ts.AnyOf2<String, ts.lib.Uint8Array>, encoding:global.BufferEncoding, ?callback:(err:ts.lib.Error) -> Void):Bool { })
	function write(chunk:ts.AnyOf2<String, ts.lib.Uint8Array>, ?callback:(err:ts.lib.Error) -> Void):Bool;
	...
	function createPushResponse(headers:node.http.OutgoingHttpHeaders, callback:(err:Null<ts.lib.Error>, res:Http2ServerResponse) -> Void):Void;
	@:overload(function(event:String, listener:() -> Void):Http2ServerResponse { })
	@:overload(function(event:String, listener:(error:ts.lib.Error) -> Void):Http2ServerResponse { })
	@:overload(function(event:String, listener:() -> Void):Http2ServerResponse { })
