...
typedef SecureServerOptions = {
	...
	var Http1IncomingMessage : {
		...
		**/
		function from(iterable:ts.AnyOf2<ts.lib.Iterable<Dynamic>, ts.lib.AsyncIterable<Dynamic>>, ?options:node.stream.ReadableOptions):node.stream.Readable;
	...
	**/
	...
	@:optional
	function pskCallback(socket:node.tls.TLSSocket, identity:String):Null<ts.AnyOf10<ts.lib.Uint8Array, ts.lib.Uint8ClampedArray, ts.lib.Uint16Array, ts.lib.Uint32Array, ts.lib.Int8Array, ts.lib.Int16Array, ts.lib.Int32Array, ts.lib.Float32Array, ts.lib.Float64Array, ts.lib.DataView>>;
	/**
	...
	**/
	@:optional
	var ALPNProtocols : ts.AnyOf3<Array<String>, ts.lib.Uint8Array, Array<ts.lib.Uint8Array>>;
	/**
