...
@:jsRequire("url", "URLSearchParams") extern class URLSearchParams {
	function new(?init:ts.AnyOf5<String, global.nodejs.Dict<ts.AnyOf2<String, Array<String>>>, Array<ts.Tuple2<String, String>>, URLSearchParams, ts.lib.Iterable<ts.Tuple2<String, String>>>);
