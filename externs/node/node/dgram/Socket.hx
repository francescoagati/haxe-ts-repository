...
@:jsRequire("dgram", "Socket") extern class Socket extends node.events.EventEmitter {
	...
	@:overload(function(msg:ts.AnyOf3<String, Array<Dynamic>, ts.lib.Uint8Array>, ?port:Float, ?callback:(error:Null<ts.lib.Error>, bytes:Float) -> Void):Void { })
	@:overload(function(msg:ts.AnyOf3<String, Array<Dynamic>, ts.lib.Uint8Array>, ?callback:(error:Null<ts.lib.Error>, bytes:Float) -> Void):Void { })
	@:overload(function(msg:ts.AnyOf2<String, ts.lib.Uint8Array>, offset:Float, length:Float, ?port:Float, ?address:String, ?callback:(error:Null<ts.lib.Error>, bytes:Float) -> Void):Void { })
	@:overload(function(msg:ts.AnyOf2<String, ts.lib.Uint8Array>, offset:Float, length:Float, ?port:Float, ?callback:(error:Null<ts.lib.Error>, bytes:Float) -> Void):Void { })
	@:overload(function(msg:ts.AnyOf2<String, ts.lib.Uint8Array>, offset:Float, length:Float, ?callback:(error:Null<ts.lib.Error>, bytes:Float) -> Void):Void { })
	function send(msg:ts.AnyOf3<String, Array<Dynamic>, ts.lib.Uint8Array>, ?port:Float, ?address:String, ?callback:(error:Null<ts.lib.Error>, bytes:Float) -> Void):Void;
