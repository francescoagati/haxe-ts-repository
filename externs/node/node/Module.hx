...
@:jsRequire("module") extern class Module {
	...
	static var Module : {
		...
		**/
		...
		function findSourceMap(path:String, ?error:ts.lib.Error):node.module.SourceMap;
	...
	**/
	...
	static function findSourceMap(path:String, ?error:ts.lib.Error):node.module.SourceMap;
}