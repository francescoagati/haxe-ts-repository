...
@:jsRequire("stream", "Writable") extern class Writable extends Stream {
	...
	@:overload(function(chunk:Dynamic, encoding:global.BufferEncoding, ?cb:(error:Null<ts.lib.Error>) -> Void):Bool { })
	...
	**/
	...
	@:overload(function(event:String, listener:(err:ts.lib.Error) -> Void):Writable { })
	@:overload(function(event:String, listener:() -> Void):Writable { })
