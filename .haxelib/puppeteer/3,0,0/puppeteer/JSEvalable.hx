...
typedef JSEvalable<A> = {
	...
	**/
	function evaluateHandle(pageFunction:ts.AnyOf2<String, (arg1:A, args:haxe.extern.Rest<Dynamic>) -> Dynamic>, args:haxe.extern.Rest<SerializableOrJSHandle>):js.lib.Promise<JSHandle<Dynamic>>;
};